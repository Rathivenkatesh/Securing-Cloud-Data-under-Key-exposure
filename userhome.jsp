<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.TMACS.conn.listoffiles"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.TMACS.conn.dataconncationlayer"%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <main class="site-main page-main">
        <div class="container">
            ...
            <br>
             <%
             ArrayList<listoffiles> list1=(ArrayList)dataconncationlayer.requst(); 
                		...
                		while(it.hasNext()){
                			...
                			out.print("<td><a href='/Securing_cloud_data/business?id="+li.getId()+"&&table=request'>request</a></td>");
                			out.print("<tr>");
                			}else{
                				out.print("<tr>");
                    			listoffiles li=(listoffiles)it.next();
