...
<body>
  ...
  <tr><td>password<br><br></td><td><input type="password" name="ps"></input><br><br></td></tr>
   <tr><td><br><br></td><td><input type="text" name="type" value="cloude" hidden></input><br><br></td></tr>
  <tr><td><br><br></td><td><input type="submit" value="Cloude Login" name="table"></input><br><br></td></tr>
  </table>
  </center>
  </form>
            </div>
