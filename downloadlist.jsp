...
<body>
    ...
    <main class="site-main page-main">
        <div class="container">
  		...
  		<%ArrayList<listofuser> list1=(ArrayList)dataconncationlayer.getusers(); 
						Iterator it=list1.iterator();
                		while(it.hasNext()){
                			out.print("<tr>");
                			listofuser li=(listofuser)it.next();
                			out.print("<td>"+li.getName()+"</td>");
                			out.print("<td>"+li.getLast()+"</td>");
                			out.print("<td>"+li.getEmail()+"</td>");
                			out.print("<td>"+li.getRole()+"</td>");
                			out.print("<td>"+li.getPh()+"</td>");
                			out.print("</tr>");
                		}
				%>
				</table>
