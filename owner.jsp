...
<body>
  ...
  <table>
  <caption width="60%">Owner Login<br><br></caption>
  <tr><td></td><td><% if(request.getParameter("mes")!=null){
	  out.print(request.getParameter("mes"));
  }%></td></tr>
  <tr><td>Email id<br></br></td><td><input type="email" name="email" ></input><br><br></td></tr>
  <tr><td>password<br><br></td><td><input type="password" name="ps"></input><br><br></td></tr>
   <tr><td><br><br></td><td><input type="text" name="type" value="owner" hidden></input><br><br></td></tr>
  <tr><td><br><br></td><td><input type="submit" value="Owner Login" name="table"></input><br><br></td></tr>
  </table>
  </center>
  </form>  
            </div>
